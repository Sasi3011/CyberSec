...
**SasikiranSec** is a security platform by **Sasikiran** — an IDS/IPS engine that detects malicious behavior and automatically blocks bad IPs through a Windows Firewall bouncer.

This project is a personalized fork of [CrowdSec](https://github.com/crowdsecurity/crowdsec), rebranded for local development and demos.
...
Based on CrowdSec (MIT License). See upstream project for full license terms.
